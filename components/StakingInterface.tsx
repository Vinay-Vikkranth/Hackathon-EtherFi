...
export default function StakingInterface() {
  ...
  const handleStake = async () => {
    ...
    try {
      ...
      setStakeAmount('');
      setReceiveAmount('');
      alert('✅ Staking successful! Check your Portfolio to see your eETH balance.');
  ...
  if (!account) {
    return (
      <div className="gradient-card rounded-2xl p-12 text-center">
        ...
        <p className="text-gray-400">Please connect your wallet to start staking</p>
      </div>
    );
  }
        ...
        <div className="tutorial-welcome">
          ...
          >
            <ul className="space-y-2 text-sm">
              <li><strong>Stake:</strong> Lock your ETH and receive eETH tokens (1:1 ratio)</li>
              <li><strong>eETH tokens:</strong> Represent your staked ETH + earn 3.5% APR automatically</li>
              <li><strong>Use eETH:</strong> Trade, provide liquidity, or wrap to weETH while still earning rewards</li>
              <li><strong>Unstake:</strong> Burn eETH anytime to get your ETH back plus accumulated rewards</li>
            </ul>
          </InfoBox>
        </div>
      )}
      ...
      <div className="flex gap-2 bg-dark-700 p-1 rounded-lg w-fit">
        ...
        <button
          onClick={() => {
            ...
            const hasSeenWrapTutorial = localStorage.getItem('hasSeenWrapTutorial');
        ...
        <div className="space-y-4">
          ...
          <div className="bg-dark-700 rounded-xl p-4">
            <div className="flex justify-between items-center mb-2">
              ...
              <span className="text-sm text-gray-400 tutorial-balance">
                Balance: {parseFloat(activeMode === 'stake' ? ethBalance : eethBalance).toFixed(4)} {activeMode === 'stake' ? 'ETH' : 'eETH'}
              </span>
            </div>
          ...
          <div className="flex justify-between text-sm">
            ...
            <span className="font-medium">
              1 {activeMode === 'stake' ? 'ETH' : 'eETH'} = 1 {activeMode === 'stake' ? 'eETH' : 'weETH'}
            </span>
          </div>
          ...
          >
            {isLoading ? 'Processing...' : activeMode === 'stake' ? 'Stake' : 'Wrap'}
          </button>
